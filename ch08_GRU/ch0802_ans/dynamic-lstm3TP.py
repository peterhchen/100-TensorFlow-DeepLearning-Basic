...
X_batch = np.array([
  # t = 0      t = 1      t = 2
  [[0, 1, 2], [9, 8, 7], [1, 8, 6]], # instance 0
  [[3, 4, 5], [0, 0, 0], [2, 1, 3]], # instance 1
  [[6, 7, 8], [6, 5, 4], [5, 4, 8]], # instance 2
  [[9, 0, 1], [3, 2, 1], [8, 1, 4]], # instance 3
])
...
###################################################################
# outputs => output of ALL LSTM states 
# states  => output of LAST ACTUAL LSTM state (ignores zero vector)
